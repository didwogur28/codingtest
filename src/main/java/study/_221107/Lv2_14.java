...
/*
  ...
  - 제한사항
   1) 1 ≤ order의 길이 ≤ 1,000,000
   2) order는 1이상 order의 길이 이하의 모든 정수가 한번씩 등장합니다.
   3) order[i]는 기존의 컨테이너 벨트에 order[i]번째 상자를 i+1번째로 트럭에 실어야 함을 의미합니다.
