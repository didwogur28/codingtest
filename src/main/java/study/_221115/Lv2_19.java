...
/*
  ...
  - 제한사항
   1) 1 ≤ queue1의 길이 = queue2의 길이 ≤ 300,000
   2) 1 ≤ queue1의 원소, queue2의 원소 ≤ 109
   3) 주의: 언어에 따라 합 계산 과정 중 산술 오버플로우 발생 가능성이 있으므로 long type 고려가 필요합니다.
...
public class Lv2_19 {
    ...
    public static void main(String[] args) {
        ...
        int solution = solution(new int[]{3, 2, 7, 2}, new int[]{4, 6, 5, 1});
